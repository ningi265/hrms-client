...
import { Error, CreditCard, Description, Inventory, ShoppingCart, LocalShipping } from "@mui/icons-material"
...
import ApprovalDashboardPage from "./approvals/approvals"
  ...
  const allData = [
    {
      ...
      value: stats.requisitions.counts.pending,
      category: "Requisitions",
      status: "pending",
    },
    {
      name: "Approved Requisitions",
      value: stats.requisitions.counts.approved,
      category: "Requisitions",
      status: "approved",
    },
    {
      name: "Rejected Requisitions",
      value: stats.requisitions.counts.rejected,
      category: "Requisitions",
      status: "rejected",
    },
    ...
    {
      name: "Approved POs",
      value: stats.purchaseOrders.counts.approved,
      category: "Purchase Orders",
      status: "approved",
    },
    {
      name: "Rejected POs",
      value: stats.purchaseOrders.counts.rejected,
      category: "Purchase Orders",
      status: "rejected",
    },
  ...
  const handlePlanSelection = async (planName) => {
    try {
      ...
      const response = await fetch(`${backendUrl}/api/billing/create-checkout-session`, {
        ...
        body: JSON.JSON.stringify({ planName }),
      })
            ...
            >
              ...
              >
                <Box sx={{ display: "flex", justifyContent: "center" }}>
                  <DotLottieReact src="spinner.lottie" loop autoplay style={{ width: 120, height: 120 }} />
                </Box>
          ...
          {activeSection === "dashboard" ? (
            ...
            >
              <Box
                sx={{
                  ...
                  alignItems: "center",
                  mb: { xs: 2, md: 2.5 }, // Added margin-bottom to create space before StatsCardsGrid
              ...
              >
                <Box>
                  ...
                  >
                    Welcome back {user.firstName.charAt(0).toUpperCase() + user.firstName.slice(1)}, here's what's
                    happening with your procurement activities.
                  </Typography>
                </Box>
              </Box>
            ...
            <Box>
              ...
              {activeSection === "fleet-management" && (
                <MobileLayoutWrapper>
                  <FleetCoordinatorSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "travel-requests" && (
                <MobileLayoutWrapper>
                  <SupervisorApprovalSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "new-requisition" && (
                <MobileLayoutWrapper>
                  <NewRequisitionSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "manage-rfq" && (
                <MobileLayoutWrapper>
                  <ManageRequisitionsSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "rfq-details" && (
                <MobileLayoutWrapper>
                  <RFQDetailsSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "create-rfq" && (
                <MobileLayoutWrapper>
                  <CreateRFQSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "add-vendor" && (
                <MobileLayoutWrapper>
                  <AddVendorSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "vendor-rfq" && (
                <MobileLayoutWrapper>
                  <VendorRFQsSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "select-vendor" && (
                <MobileLayoutWrapper>
                  <SelectVendorSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "vendor-purchase-orders" && (
                <MobileLayoutWrapper>
                  <VendorPODetailsSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "track-deliveries" && (
                <MobileLayoutWrapper>
                  <TrackDeliveriesSection />
                </MobileLayoutWrapper>
              )}
              ...
              {activeSection === "payment" && (
                <MobileLayoutWrapper>
                  <PaymentPage invoiceData={paymentData} onBack={handleBackFromPayment} authContext={{ user }} />
                </MobileLayoutWrapper>
              )}
              {activeSection === "supervisor-approval" && (
                <MobileLayoutWrapper>
                  <SupervisorApprovalSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "final-approval" && (
                <MobileLayoutWrapper>
                  <FinalApproverSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "finance-processing" && (
                <MobileLayoutWrapper>
                  <FinanceProcessingSection />
                </MobileLayoutWrapper>
              )}
              ...
              {activeSection === "international-travel" && (
                <MobileLayoutWrapper>
                  <InternationalTravelRequestSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "recon-review" && (
                <MobileLayoutWrapper>
                  <FinanceReconciliationReviewSection />
                </MobileLayoutWrapper>
              )}
              {activeSection === "fleet-cordination" && (
                <MobileLayoutWrapper>
                  <FleetCoordinatorSection />
                </MobileLayoutWrapper>
              )}
              ...
              {activeSection === "employees-details" && (
                <MobileLayoutWrapper>
                  <EmployeeDetailPage />
                </MobileLayoutWrapper>
              )}
              {activeSection === "employees-edit" && (
                <MobileLayoutWrapper>
                  <EditEmployeePage />
                </MobileLayoutWrapper>
              )}
              {activeSection === "employee-performance" && (
                <MobileLayoutWrapper>
