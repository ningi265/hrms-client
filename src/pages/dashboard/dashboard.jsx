...
export default function DashboardPage() {
  ...
  const procurementStages = [
    ...
    },
    {
      ...
      icon: <Truck className="h-5 w-5" />,
      description: "Approve travel requests and process payments.",
      action: "Approve Travel Requests",
      path: "/travel/fleet/cordinator",
      stats: stats.invoices,
    },
    {
      ...
      description: "Approve travel requests and process payments.",
      action: "Approve Travel Requests",
      path: "/travel/recon/finance/processing",
      stats: stats.invoices,
    },
    {
      id: "reconciliation",
      ...
      description: "Submit travel expenses and reconcile payments.",
      action: "Submit Expenses",
      path: "/travel/recon/finance/review",
      stats: stats.invoices,
    },
    {
